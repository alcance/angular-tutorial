var nominaApp = angular.module('nominaApp', []);

nominaApp.controller('ControladorFiltros', function($scope){
    $scope.empleados =
    [
      {
      ...
      {
        nombre:'Ivan', paterno: 'Martinez', materno: 'Aguero', primerDia:  new Date(),
